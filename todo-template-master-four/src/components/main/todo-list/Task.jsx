   ...
   render(){
      ...
      return (
         <>
            <li className={name}>
               <div className="view">
                  {name === 'completed' ? <input className="toggle" type="checkbox" onClick={ onToggleItem } checked/> : <input className="toggle" type="checkbox" onClick={ onToggleItem }/>}                  
                  <label>
               ...
               {name === 'editing' ?          
                  <form onSubmit={this.onSubmit}>       
                     <input type="text"
                           className="edit"     
                           onChange={this.onLabelChangeTwo}
